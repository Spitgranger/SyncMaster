export async function signupUser(
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_API_BASE_URL}/protected/users/signup`,
    {
      method: 'POST',
      headers: {
...
export async function resetPassword(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/protected/users/reset-password`,
      {
        method: 'POST',
        headers: {
          Authorization: `${IdToken}`,
...
export async function signinUser(email: string, password: string) {
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/unprotected/auth/signin`,
      {
        method: 'POST',
...
export async function signoutUser(token: string) {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_API_BASE_URL}/users/signout?user_token=${token}`,
    {
      method: 'GET',
