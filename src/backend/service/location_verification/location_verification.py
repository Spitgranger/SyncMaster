...
from ..environment import TARGET_LATITUDE, TARGET_LONGITUDE, ACCEPTABLE_RADIUS_METERS
...
def verify_location(location_request: LocationVerificationRequest) -> dict:
    ...
    """
    distance = haversine(location_request.latitude, location_request.longitude, TARGET_LATITUDE, TARGET_LONGITUDE)
