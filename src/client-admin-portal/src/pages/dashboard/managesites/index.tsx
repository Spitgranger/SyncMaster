      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <TextField
            ...
            helperText={
              !isSiteIdValid && newSite.siteId.length > 0
                ? 'Site ID must be exactly 5 characters long'
                : ''
            }
          />
          <TextField
        ...
        <DialogActions>
          <Button onClick={handleCloseDialog} disabled={isAddingSite}>
            Cancel
          </Button>
          <Button
            onClick={handleCreateSite}
            variant="contained"
            disabled={!isSiteIdValid || isAddingSite}
          >
            Create
          </Button>
        </DialogActions>
