...
export const uploadDocument = createAsyncThunk(
    ...
    async (uploadData: any) => {
        ...
        const { site_id, document_name, document_type, parent_folder_id, document_path, user_id, idToken, requires_ack, document_expiry, fileBlob } = uploadData
        ...
        const documentEntryUploadResponse = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/protected/documents/upload`, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `${idToken}`
            },
...
export const deleteDocument = createAsyncThunk(
    ...
    async (deleteData: any) => {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/protected/documents/delete?${queryParams}`, {
            headers: {
                "Authorization": `${idToken}`
            },
            method: "DELETE"
