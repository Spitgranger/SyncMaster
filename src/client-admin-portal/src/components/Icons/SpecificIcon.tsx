  ...
  return (
    ...
    >
      <g fill="none" stroke="black" strokeLinejoin="round" strokeWidth={4}>
        ...
        ></path>
        <path d="M24 35s13-8.496 13-18.318C37 9.678 31.18 4 24 4S11 9.678 11 16.682C11 26.504 24 35 24 35Z"></path>
        <path d="M24 22a5 5 0 1 0 0-10a5 5 0 0 0 0 10Z"></path>
      </g>
    </svg>
  );
};
