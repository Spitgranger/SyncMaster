...
import { Dialog, DialogActions, DialogContent, DialogTitle, CircularProgress, Typography, IconButton, Box, Menu, MenuItem, TextField, Radio, RadioGroup, FormControlLabel, FormControl, FormLabel } from '@mui/material';
...
export default function FileUploaderComponent(props: { site_id: any; parent_folder_id: any; document_path: any; user_id: any; idToken: any; }) {
    ...
    const [folderUploadStatusMessage, setFolderUploadStatusMessage] = useState(""); // To hold folder upload status message
    const [folderUploadStatusType, setFolderUploadStatusType] = useState("success"); // "success" or "error"
                ...
                <DialogActions>
                    {!isFolderUploading && (
                        <>
                            ...
                            <Button onClick={handleFolderCreation} variant="contained">Create</Button>
                        </>
                    )}
                </DialogActions>
            </Dialog>
                        ...
                        <>
                            ...
                            <Box mt={2}>
                                <FormControl component="fieldset">
                                    <FormLabel component="legend">Does this document require acknowledgment?</FormLabel>
                                    <RadioGroup
                                        row
                                        value={requiresAcknowledgement}
                                        onChange={(e) => setRequiresAcknowledgement(e.target.value === "true")}
                                    >
