...
\begin{tabularx}{\textwidth}{p{3cm}p{3cm}X}
  ...
  03/30/2025 & Kyle D'Souza & Move MS-MTN-5 into future development plan by city\\
  03/31/2025 & Mitchell Hynes & Add multi-factor authentication to future development\\
  \bottomrule
\end{tabularx}
\pagenumbering{arabic}
~\\
...
\href{https://github.com/Spitgranger/SyncMaster/blob/main/docs/ProblemStatementAndGoals/ProblemStatement.pdf}
{here}.
...
\begin{enumerate}[{PR-PA}1.]
  ...
  \item \sout{A data integrity of 99.99\% should be maintained to ensure no
    ...
    \textcolor{red}{Removing requirement on assumption cloud service provider will ensure integrity of its services}.
\end{enumerate}
...
\begin{enumerate}[{PR-CR}1.]
  \item \sout{The system should be able to support peak data transfer rate
    ...
    \textcolor{red}{Removing as this is dependent on the internet speed of the user and outside of our control}.
...
\begin{enumerate}[{PR-SE}1.]
  ...
  \item \sout{The system should be able to distribute traffic evenly and
    ...
    \textcolor{red}{Removing as this will be handled by external cloud provider}.
\end{enumerate}
...
\begin{enumerate} [{SR-PR}1.]
  ...
  \item \sout{The application should protect private information in accordance with
    any and all government privacy laws and policies.}\\
    \textcolor{red}{Removing as verifying legal requirements is beyond the scope and skills of a small student software engineering team}.
\end{enumerate}
...
\begin{enumerate}[{CR-L}1.]
  ...
  \item \sout{The application is to process any sensitive information per the
    ...
    \textcolor{red}{Removing as verifying legal requirements is beyond the scope and skills of a student software engineering team}.
\end{enumerate}
...
\begin{enumerate}[{CR-S}1.]
  \item \sout{Documentation which must be stored on the City's BCOS
    ...
    \textcolor{red}{Removing as application will not be connecting to any existing City platforms}.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textit{Future revisions}: To be completed by the City of Hamilton by future manintainers. Includes MS-MTN5
