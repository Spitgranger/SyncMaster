...
\begin{itemize}
  \item transition: $issuedTokens \rightarrow issuedTokens \cup
    ...
    tokens are tracked, issued and validated using AWS Cognito.
...
\begin{itemize}
  \item transition: $issuedTokens \rightarrow issuedTokens \cup
    ...
    Location Verification Module and where tokens are tracked, issued
    and validated using AWS Cognito.
  \item output: $authToken$ where $authToken$ is uniquely generated
    for the user.
