...
\begin{enumerate}
  ...
  \item What pain points did you experience during this deliverable, and how
    ...
    to use, such as choosing an EC2 instance or using AWS lambda scaling to 0.
    This was resolve through discussion of what the advantages of one
    tool would be over another. For this particular problem,
    it was decided to use AWS lambda with scaling to 0, as the
    application could scale down to save cost during non-work hours.
  ...
  \item Give a brief overview of other design solutions you considered.  What
    ...
    presigned URLs that would permit larger uploads than uploading through API Gateway.
\end{enumerate}
