...
\begin{center}
  \begin{tabular}{p{2cm} p{4cm} p{2cm} p{2cm}}
    ...
    \textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
    \hline
    createJob & \textbf{jobType:}string, \textbf{workOrder:}int, \textbf{userID:}string, \textbf{description:}string & \textbf{jobID:}string & ExternalServiceFailure in AWS \\
    editJob & \textbf{jobID:}string, \textbf{workOrder:}int, \textbf{description:}string, \textbf{jobType:}string & None & ExternalServiceFailure in AWS \\
    completeJob & \textbf{jobID:}string & None & ExternalServiceFailure in AWS\\
    deleteJob & \textbf{jobID:}string & None & ExternalServiceFailure in AWS\\
    \hline
  \end{tabular}
\end{center}
...
\begin{itemize}
  ...
  \item exception: ExternalServiceFailure if method fails
\end{itemize}
...
\begin{itemize}
  ...
  \item exception: ExternalServiceFailure in AWS
\end{itemize}
