...
\item[\refstepcounter{acnum} \actheacnum \label{acLocationThreshod}:] Changes in
...
\item[\refstepcounter{acnum} \actheacnum \label{acDataLogs}:] Analytic
  information requested by administrators, such as located-based usage patterns.
...
\begin{description}
\item[\refstepcounter{ucnum} \uctheucnum \label{ucLocation}:] Removing location
  authentication features completely.
\item[\refstepcounter{ucnum} \uctheucnum \label{ucAWS}:] AWS as cloud
  infrastructure provider.
\item[\refstepcounter{ucnum} \uctheucnum \label{ucAWS}:] Removing document uploading, sharing, or storage functionalities.
\end{description}
...
\begin{description}
\item [\refstepcounter{mnum} \mthemnum \label{mAC}:] Audit and Compliance Module
...
\item [\refstepcounter{mnum} \mthemnum \label{mLV}:] Location Verification
  Module
\item [\refstepcounter{mnum} \mthemnum \label{mAR}:] Analysics and Reporting
  Module
\item [\refstepcounter{mnum} \mthemnum \label{mUM}:] User Management Module
\item [\refstepcounter{mnum} \mthemnum \label{mDM}:] Document Management Module
...
\item [\refstepcounter{mnum} \mthemnum \label{mDI}:] Database Interaction Module
\item [\refstepcounter{mnum} \mthemnum \label{mBS}:] Blob Storage Interation
  Module
\item [\refstepcounter{mnum} \mthemnum \label{mRR}:] Request Routing Module
...
\multirow{7}{0.3\textwidth}{Software Decision Modules} & Audit and Compliance Module\\
...
\multirow{3}{0.3\textwidth}{Behaviour-Hiding Modules} & {API Integration Module}\\
