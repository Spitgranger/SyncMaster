...
\begin{description}
  ...
  \item[\refstepcounter{ucnum} \uctheucnum \label{ucAWS}:] Removing
...
\begin{description}
  ...
  \item[Type of Module:] [Record, Library, Abstract Object, or
    Abstract Data Type]
    [Information to include for leaf modules in the decomposition by
    secrets tree.]
\end{description}
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.2\textwidth} p{0.6\textwidth}}
    ...
    R5 & \mref{mOutput}, \mref{mODEs}, \mref{mControl},
    \mref{mSeqDS}, \mref{mSolver}, \mref{mPlot}\\
    R6 & \mref{mOutput}, \mref{mODEs}, \mref{mControl},
    \mref{mSeqDS}, \mref{mSolver}, \mref{mPlot}\\
