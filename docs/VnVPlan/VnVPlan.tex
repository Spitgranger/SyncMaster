...
\href{https://github.com/Spitgranger/SyncMaster/blob/main/docs/SRS-Volere/SRS.pdf}{SRS.pdf} document 
...
in detail outlining what methods will be used to verify the functional and non-functional
