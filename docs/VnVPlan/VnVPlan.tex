...
\begin{enumerate}
  ...
  \item{TC-EU-1\\}
    ...
    are between $\hypertarget{min_age}{MIN\_AGE}$ and $\hypertarget{min_age}{MIN\_AGE}$ age limits. No prior instructions or
  ...
  \item{TC-EU-2\\}
    ...
    Initial State: System is functional with test accounts made for users. Users
    are between $\hypertarget{min_age}{MIN\_AGE}$ and $\hypertarget{min_age}{MIN\_AGE}$ age limits.
...
\begin{enumerate}
  \item{TC-LR-1\\}
    ...
    test is considered passed. See \textbf{Section 6.2} Usability Survey Questions.
  ...
  \item{TC-LR-2\\}
    ...
    minutes the user will be asked a few questions to gauge their confidence when using the
