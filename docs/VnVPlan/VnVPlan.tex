...
\begin{enumerate}
  \item What went well while writing this deliverable?\\
    ...
    and delegate
    sections of the document between the members. We had a very productive TA
    ...
    completed later when the design of the system had been done, among other
    small questions.
  ...
  \item For each of the knowledge areas and skills identified in the previous
    ...
    \\
    Two approaches which the team believes are effective are reading the
    documentation for each of these tools and watching tutorials. By following
    these steps, the team believes that each team members skill sets with these
