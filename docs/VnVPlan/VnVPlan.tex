...
\begin{enumerate}
  ...
  \item{TC-LF-2\\}
    ...
    Input: User logs in, and views all available screens of
    the user interface while using devices of screen sizes with
    common desktop screen resolutions (1920x1080, 1366x768,
    1280x1024, 1024x768), with common mobile device screen
    resolutions (375x667, 414x736, 360x800, 390x884), or with common
    tablet screen resolutions (768x1024, 1024x768, 601x962).
    ...
    of 10, for all screen sizes, then the test is considered a success. \\
