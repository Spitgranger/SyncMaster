...
\begin{longtable}{|m{2cm}|m{1.5cm}|m{6cm}|}
  \hline
  ...
  \hline
  TC-EU-2 & User 1& User successfully navigated contractor portal. Minor difficulties understanding distinction of site wide and
  ...
  thus identifying a bug in the system to be patched for rev1.\\
  \hline
  TC-LR-1 & User 1& As an admin user, the tester was able to add a site wide document but did not receive a warning before deleting file
  thus identifying a bug in the system to be patched for rev1.\\
  \hline
  ...
  and not viewed in the application, but successfully opened the document. User gave their confidence a rating of 7.\\
  \hline
  TC-LR-1 & User 1& \\
  \hline
  TC-LR-2 & User 2& \\
