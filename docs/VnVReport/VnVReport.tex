...
User 1: Man between age of 60 - 65, no prior experience with the system. User if comfortable using a smartphone and laptop.\\
User 2: Women between age of 60 - 65, no prior experience with the system. User is comfortable using a smartphone and laptop.
Through these actions, the following results were observed:\\
\begin{longtable}{|m{2cm}|m{1cm}|m{6cm}|m{3cm}|}
  \hline
  \textbf{Test. ID}  & User & \textbf{Result} \\
  \hline
  TC-EU-1 & User 1& \\
  TC-EU-1 & User 2& \\
  TC-EU-2 & User 1& \\
