...
\begin{longtable}{|m{1cm}|m{3cm}|m{5cm}|m{3cm}|}
  ...
  Pass, documents soon to expire are highlighted in yellow, documents which have expired are highlighted in red.\\ \hline
...
\begin{longtable}{|m{2cm}|m{5cm}|m{4cm}|m{4cm}|}
  ...
  integrity during upload and retrieval & Pass, uploaded document maintains intergrity when downloaded.\\ \hline
  ...
  should be 95\% relevant to the input query & Pass, API only returns results with matching keys.\\ \hline
  TC-PR-7 & An unexpected input/event & System should handle the
  unexpected input/event gracefully and should not crash & Pass, client does not crash when API returns error messages.\\ \hline
